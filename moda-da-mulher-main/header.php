  ...
  <header class="bg-cor-primaria">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-2 my-4 text-center text-lg-start">
          <img src="assets/images/logo.svg" alt="">
        </div>

        <div class="col-md-7 my-4 d-flex align-items-center">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-secondary" href="#"><i class="bi bi-cart-fill position-relative">
                <span class="badge position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">3</span>
              </i> carrinho</a>
            </li>
          </ul>
